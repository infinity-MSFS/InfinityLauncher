...
namespace Infinity {
    ...
    void Background::RenderBackgroundBaseLayer() const {
        ...
        ImGui::GetWindowDrawList()->AddRectFilledMultiColor(m_windowPos, ImVec2(m_windowPos.x + m_windowSize.x, m_windowPos.y + m_windowSize.y), ImColor(m_primaryColor), ImColor(m_primaryColor),
    ...
    void Background::RenderBackgroundGradientLayer() const {
        ...
        RenderGradientCircle(ImVec2(m_windowPos.x + m_circlePos[0].x, m_windowPos.y + m_circlePos[0].y), 600.0f, 0.01f, ImColor(m_circleColor1));
        RenderGradientCircle(ImVec2(m_windowPos.x + m_circlePos[1].x, m_windowPos.y + m_circlePos[1].y), 400.0f, 0.01f, ImColor(m_circleColor2));
        RenderGradientCircle(ImVec2(m_windowPos.x + m_circlePos[2].x, m_windowPos.y + m_circlePos[2].y), 600.0f, 0.01f, ImColor(m_circleColor3));
        RenderGradientCircle(ImVec2(m_windowPos.x + m_circlePos[3].x, m_windowPos.y + m_circlePos[3].y), 400.0f, 0.01f, ImColor(m_circleColor4));
        RenderGradientCircle(ImVec2(m_windowPos.x + m_circlePos[4].x, m_windowPos.y + m_circlePos[4].y), 600.0f, 0.01f, ImColor(m_circleColor5));
