...
namespace ImGui {
    ...
    inline void RenderLine(const char *markdown, Line &line, TextRegion &text_region, const MarkdownConfig &markdown_config);
    ...
    public:
        ...
        static bool RenderLinkText(const char *text, const char *text_end, const Link &link, const char *markdown, const MarkdownConfig &markdown_config, const char **link_hover_start);
        void RenderLinkTextWrapped(const char *text, const char *text_end, const Link &link, const char *markdown, const MarkdownConfig &markdown_config, const char **link_hover_start,
