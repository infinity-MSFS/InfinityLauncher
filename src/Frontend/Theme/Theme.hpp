...
namespace Infinity::UI {
  ...
  namespace Colors {
    ...
    //     float hue, sat, val;
    //     ImGui::ColorConvertRGBtoHSV(col_row.x, col_row.y, col_row.z, hue,
    //     sat, val); return ImColor::HSV(hue, sat, std::min(value, 1.0f));
    // }
    //
    // inline ImU32 ColorWithSaturation(const ImColor &color, const float
    // saturation) {
    //     const ImVec4 &col_row = color.Value;
    //     float hue, sat, val;
    //     ImGui::ColorConvertRGBtoHSV(col_row.x, col_row.y, col_row.z, hue,
    //     sat, val); return ImColor::HSV(hue, std::min(saturation, 1.0f), val);
    // }
    //
    // inline ImU32 ColorWithHue(const ImColor &color, const float hue) {
    //     const ImVec4 &col_row = color.Value;
    //     float h, s, v;
    //     ImGui::ColorConvertRGBtoHSV(col_row.x, col_row.y, col_row.z, h, s,
    //     v); return ImColor::HSV(std::min(hue, 1.0f), s, v);
    // }
    //
    // inline ImU32 ColorWithMultipliedValue(const ImColor &color, const float
    // multiplier) {
    //     const ImVec4 &col_row = color.Value;
    //     float hue, sat, val;
    //     ImGui::ColorConvertRGBtoHSV(col_row.x, col_row.y, col_row.z, hue,
    //     sat, val); return ImColor::HSV(hue, sat, std::min(val *
    //     multiplier, 1.0f));
    // }
    //
    // inline ImU32 ColorWithMultipliedSaturation(const ImColor &color, const
    // float multiplier) {
    //     const ImVec4 &col_row = color.Value;
    //     float hue, sat, val;
    //     ImGui::ColorConvertRGBtoHSV(col_row.x, col_row.y, col_row.z, hue,
    //     sat, val); return ImColor::HSV(hue, std::min(sat * multiplier, 1.0f),
    //     val);
    // }
    //
    // inline ImU32 ColorWithMultipliedHue(const ImColor &color, const float
    // multiplier) {
    //     const ImVec4 &col_row = color.Value;
    //     float hue, sat, val;
    //     ImGui::ColorConvertRGBtoHSV(col_row.x, col_row.y, col_row.z, hue,
    //     sat, val); return ImColor::HSV(std::min(hue * multiplier, 1.0f), sat,
    //     val);
    // }
  }  // namespace Colors
