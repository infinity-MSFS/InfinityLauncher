...
public:
    ...
    static std::shared_ptr<Image> LoadFromMemory(const void *data,
                                                 size_t dataSize);

    static std::shared_ptr<Image> LoadFromURL(const std::string &url);

    static std::shared_ptr<Image> LoadFromBinary(
    ...
    static void *DecodeImage(const uint8_t *data, size_t dataSize,
    ...
    static void RenderImage(const std::unique_ptr<Image> &image, ImVec2 pos,
                            float scale);
    static void RenderImage(const std::shared_ptr<Image> &image, ImVec2 pos,
                            float scale);
    ...
    static void RenderHomeImage(const std::unique_ptr<Image> &image, ImVec2 pos,
                                ImVec2 size, bool is_hovered);
    static void RenderHomeImage(const std::shared_ptr<Image> &image, ImVec2 pos,
                                ImVec2 size, bool is_hovered);
