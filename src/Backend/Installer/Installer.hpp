...
namespace Infinity {
    ...
    public:
         ...
         *
         * The download pointer can be obtained by first calling GetActiveDownloadFromEnum() and then using that ID to pass to the downloader singleton
         */
    ...
    private:
        ...
        std::map<int, Groups::GroupVariants> m_GlobalDownloads; // <int id, GroupVariants name>
