...
public:
    void OnAttach() override {
        ...
        std::thread([] {
            ...
            Infinity::Home::GetInstance()->RegisterProject("Aero Dynamics",
                                                           thread_state_ptr->state.groups.at("aero_dynamics").projects[
                                                               0].background,
                                                           thread_state_ptr->state.groups.at("aero_dynamics").logo, 3);
            Infinity::Home::GetInstance()->RegisterProject("Delta Sim",
                                                           thread_state_ptr->state.groups.at("delta_sim").projects[0].
                                                           background,
                                                           thread_state_ptr->state.groups.at("delta_sim").logo, 4);
            Infinity::Home::GetInstance()->RegisterProject("Lunar Sim",
                                                           thread_state_ptr->state.groups.at("lunar_sim").projects[0].
                                                           background,
                                                           thread_state_ptr->state.groups.at("lunar_sim").logo, 5);
            Infinity::Home::GetInstance()->RegisterProject("Ouroboros Jets",
                                                           thread_state_ptr->state.groups.at("ouroboros").projects[0].
                                                           background,
                                                           thread_state_ptr->state.groups.at("ouroboros").logo,
                                                           6);
